function [best_model, model_collection, params] = estimate_parameters_series_implementation(params, models, input_collection)
...
for a = 1:modelL
    ...
    model_collection = ModelCollection2(model,params);
