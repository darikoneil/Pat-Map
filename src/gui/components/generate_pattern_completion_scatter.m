...
app.pattern_completion_scatter = axes('Parent', app.PCPanel1, 'Units', 'pixels',...
...
app.pattern_completion_scatter.Title.String = 'Pattern Completion and Ensemble Neurons';
app.pattern_completion_scatter.Title.FontName = 'Arial';
app.pattern_completion_scatter.FontName='Arial';
app.pattern_completion_scatter.FontSize=12;
app.pattern_completion_scatter.Color=[1 1 1];
end