...
identified_ensemble_performance.training_performance = calculate_ensemble_performance(app.params, app.ensemble_nodes, app.log_likelihood_by_frame, [1:size(app.params.x_train, 1)]);
