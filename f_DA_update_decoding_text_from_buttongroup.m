...
elseif viewSelection == 2
    ...
    app.Miss_EditField_Decoding.Value = strcat(num2str(round(app.trainPerf.FalseNegRatecell{v}*100,2)),'%');
...
elseif viewSelection == 3
    ...
    app.Miss_EditField_Decoding.Value = strcat(num2str(round(app.testPerf.FalseNegRatecell{v}*100,2)),'%');
    app.Threshold_Edit_Field_Decoding.Value = num2str(app.trainPerf.thcell{v});
end
