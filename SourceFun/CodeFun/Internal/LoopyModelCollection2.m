classdef LoopyModelCollection2
    ...
    methods
        function self = LoopyModelCollection2(models,params)
           self.models = models;
...
% Idk if this definition is right.... In regards to which states are in
% which ORDER
