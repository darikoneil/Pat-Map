classdef PatMap_exported < matlab.apps.AppBase
    ...
    properties (Access = public)
        ...
        v099Label                       matlab.ui.control.Label
        ...
        ReservedField_EV_1              matlab.ui.control.Label
        ReservedEditField_EV_1          matlab.ui.control.NumericEditField
        ReservedButton_EV               matlab.ui.control.Button
        ReservedField_EV_2              matlab.ui.control.Label
        ReservedEditField_EV_2          matlab.ui.control.NumericEditField
    ...
    methods (Access = private)
        ...
        function RecurrentInteractionsEditFieldValueChanged(app, event)
            app.params.no_neurons_same_edges = logical(app.RecurrentInteractionsEditField.Value);
            f_DA_update_params(app);
        end
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            % Create v099Label
            app.v099Label = uilabel(app.IOPanel);
            app.v099Label.FontName = 'Arial';
            app.v099Label.FontSize = 20;
            app.v099Label.FontWeight = 'bold';
            app.v099Label.Position = [91 75 61 24];
            app.v099Label.Text = 'v0.9.9';
            ...
            app.TemporalInteractionsEditFieldLabel.Position = [49 191 120 22];
            ...
            app.TemporalInteractionsEditField.Position = [170 191 100 22];
            ...
            app.RecurrentInteractionsEditFieldLabel.Position = [43 147 124 22];
            ...
            app.RecurrentInteractionsEditField.Position = [170 147 100 22];
            ...
            app.MergeNodeClassesEditField.Position = [170 103 100 22];
            ...
            app.MergeNodeClassesEditFieldLabel.Position = [51 103 118 22];
            ...
            app.UDFUDFInteractionsEditFieldLabel.Position = [44 59 124 22];
            ...
            app.UDFUDFInteractionsEditField.Limits = [0 1];
            ...
            app.UDFUDFInteractionsEditField.Position = [170 59 100 22];
            ...
            app.RankAbsoluteValueofCoefficientsEditField.Position = [170 15 100 22];
            ...
            app.RankAbsoluteValueofCoefficientsEditFieldLabel.Position = [36 15 133 22];
            ...
            app.NumberofStructuresEditFieldLabel.Position = [348 59 120 22];
            ...
            app.NumberofStructuresEditField.Position = [470 59 100 22];
            ...
            app.NumberofModelsEditFieldLabel.Position = [364 15 104 22];
            ...
            app.NumberofModelsEditField.Position = [470 15 100 22];
            ...
            app.ShuffledDataasControlsEditFieldLabel.Position = [607 411 142 22];
            ...
            app.ShuffledDataasControlsEditField.Position = [750 411 100 22];
            ...
            app.AssessNeuronsEditFieldLabel.Position = [655 367 93 22];
            ...
            app.AssessNeuronsEditField.Position = [750 367 100 22];
            ...
            app.AssessNodesEditFieldLabel.Position = [666 323 82 22];
            ...
            app.AssessNodesEditField.Position = [750 323 100 22];
            ...
            app.AssessLinearityEditFieldLabel.Position = [656 279 93 22];
            ...
            app.AssessLinearityEditField.Position = [750 279 100 22];
            ...
            app.AssessDecodingEditFieldLabel.Position = [650 235 98 22];
            ...
            app.AssessDecodingEditField.Position = [750 235 100 22];
            ...
            app.AssessClusteringEditFieldLabel.Position = [641 191 102 22];
            ...
            app.AssessClusteringEditField.Position = [750 191 100 22];
            ...
            app.NewModelEditField.Position = [350 168 500 22];
            ...
            app.UDFUDFInteractionsEditField_SL.Editable = 'off';
            ...
            app.RankAbsoluteValueofCoefficientsEditField_SL.Position = [789 14 100 22];
            ...
            app.RankAbsoluteValueofCoefficientsEditFieldLabel_2.Position = [652 13 133 22];
            ...
            app.RecurrentInteractionsEditField_2Label.Position = [661 54 124 22];
            ...
            app.RecurrentInteractionsEditField_SL.Position = [789 54 100 22];
            ...
            app.MaxTimeEditField_PE.Editable = 'off';
            ...
            app.PrintIntervalEditField_PE.Editable = 'off';
            ...
            app.GlobalEM.RoundFractionalValues = 'on';
            app.GlobalEM.ValueDisplayFormat = '%.0f';
            ...
            app.LocalEM.RoundFractionalValues = 'on';
            app.LocalEM.ValueDisplayFormat = '%.0f';
            ...
            app.MissLabel_Decoding.Position = [290 16 30 22];
            ...
            app.Miss_EditField_Decoding.Position = [335 16 100 22];
            ...
            app.StimulusLabel = uilabel(app.PredictionPerformancePanel_Decoding);
            app.StimulusLabel.HorizontalAlignment = 'right';
            app.StimulusLabel.FontName = 'Arial';
            app.StimulusLabel.FontSize = 16;
            app.StimulusLabel.FontWeight = 'bold';
            app.StimulusLabel.Position = [267 247 73 22];
            ...
            app.DeviationsEditField.FontSize = 16;
            app.DeviationsEditField.Position = [851 75 44 40];
            app.DeviationsEditField.Value = 1;

            % Create StimulusEditFieldLabel
            app.StimulusEditFieldLabel = uilabel(app.IDParams);
            ...
            app.StimulusEditFieldLabel.FontWeight = 'bold';
            app.StimulusEditFieldLabel.Position = [771 25 73 22];
            ...
            app.ThresholdEditFieldLabel.FontSize = 16;
            app.ThresholdEditFieldLabel.Position = [767 145 77 22];
            ...
            app.ThresholdEditField.FontSize = 16;
            app.ThresholdEditField.Position = [851 135 44 40];
            ...
            app.DeviationsLabel.FontSize = 16;
            app.DeviationsLabel.Position = [761 83 80 22];
            ...
            % Create ReservedField_EV_1
            app.ReservedField_EV_1 = uilabel(app.EnsembleEvalParams);
            app.ReservedField_EV_1.HorizontalAlignment = 'right';
            app.ReservedField_EV_1.FontName = 'Arial';
            app.ReservedField_EV_1.Enable = 'off';
            app.ReservedField_EV_1.Visible = 'off';
            app.ReservedField_EV_1.Position = [67 58 27 22];
            app.ReservedField_EV_1.Text = 'Res';

            % Create ReservedEditField_EV_1
            app.ReservedEditField_EV_1 = uieditfield(app.EnsembleEvalParams, 'numeric');
            app.ReservedEditField_EV_1.Limits = [0 1];
            app.ReservedEditField_EV_1.ValueDisplayFormat = '%.0f';
            app.ReservedEditField_EV_1.FontName = 'Arial';
            app.ReservedEditField_EV_1.Enable = 'off';
            app.ReservedEditField_EV_1.Visible = 'off';
            app.ReservedEditField_EV_1.Position = [101 58 100 22];
            ...
            % Create ReservedField_EV_2
            app.ReservedField_EV_2 = uilabel(app.EnsembleEvalParams);
            app.ReservedField_EV_2.HorizontalAlignment = 'right';
            app.ReservedField_EV_2.FontName = 'Arial';
            app.ReservedField_EV_2.Enable = 'off';
            app.ReservedField_EV_2.Visible = 'off';
            app.ReservedField_EV_2.Position = [67 18 27 22];
            app.ReservedField_EV_2.Text = 'Res';

            % Create ReservedEditField_EV_2
            app.ReservedEditField_EV_2 = uieditfield(app.EnsembleEvalParams, 'numeric');
            app.ReservedEditField_EV_2.Limits = [0 1];
            app.ReservedEditField_EV_2.ValueDisplayFormat = '%.0f';
            app.ReservedEditField_EV_2.FontName = 'Arial';
            app.ReservedEditField_EV_2.Enable = 'off';
            app.ReservedEditField_EV_2.Visible = 'off';
            app.ReservedEditField_EV_2.Position = [101 18 100 22];
            ...
            app.MissLabel_Eval.Position = [290 16 30 22];
            app.MissLabel_Eval.Text = 'Miss';
            ...
            app.StimulusLabel_2 = uilabel(app.PredictionPerformancePanel_Decoding_2);
            app.StimulusLabel_2.HorizontalAlignment = 'right';
            app.StimulusLabel_2.FontName = 'Arial';
            app.StimulusLabel_2.FontSize = 16;
            app.StimulusLabel_2.FontWeight = 'bold';
            app.StimulusLabel_2.Position = [267 247 73 22];
            ...
            app.StimulusLabel_3 = uilabel(app.PCNParams);
            app.StimulusLabel_3.HorizontalAlignment = 'right';
            app.StimulusLabel_3.FontName = 'Arial';
            app.StimulusLabel_3.FontSize = 14;
            app.StimulusLabel_3.FontWeight = 'bold';
            app.StimulusLabel_3.Position = [31 79 65 40];
    ...
    methods (Access = public)
        ...
        % Construct app
        function app = PatMap_exported

            %Add Paths added 05/17/2022
            f_DA_init_app()
            % Create UIFigure and components
